/*
   ...
   No Linux  :   gcc -o Guia_00   ./Guia_00.cpp
   No Windows:   gcc -o Guia_00.exe Guia_00.cpp

   OBS.: O arquivo de biblioteca com as definicoes
         karel.h devera' estar disponivel na mesma
         pasta do programa.
